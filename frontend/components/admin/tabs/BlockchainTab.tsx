...
export function BlockchainTab() {
  const contractInfo = [
    ...
    { label: 'BEP-20 VOLTARA Token Contract', value: '0x32A4e9b891bF953C35C7e12739343997F4aA5726', link: 'https://bscscan.com/token/0x32A4e9b891bF953C35C7e12739343997F4aA5726', status: 'VERIFIED' },
    { label: 'Treasury / Hot Payout Wallet', value: '0x71C...B42a', balance: '1,450,200 VOLTARA', gasBalance: '4.82 BNB', status: 'SUFFICIENT_LIQUIDITY' },
