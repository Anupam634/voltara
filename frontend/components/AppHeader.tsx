      ...
      >
        ...
        <div className="flex items-center gap-2">
          <Link
            ...
            className="hidden sm:flex items-center gap-1 rounded-full border border-amber-500/30 bg-amber-500/10 px-2.5 py-1 text-[11px] font-bold text-amber-300 hover:bg-amber-500/20 transition-all"
          >
            <span>👥</span>
            <span>Referrals</span>
          </Link>
