...
const en = {
  ...
  tooMany: 'A rig has six slots, so only the first six parts were loaded.',
...
const ko: Copy = {
  ...
  tooMany: '리그는 슬롯이 여섯 개라 앞의 여섯 부품만 불러왔습니다.',
  yourBuild: '내 리그 코드',
